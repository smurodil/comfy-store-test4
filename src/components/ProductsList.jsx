  ...
  return (
    <div className="mt-12 grid gap-y-8">
        {products.map((product) => {
            ...
            return(
                <Link className="p-8 rounded-lg flex flex-col sm:flex-row gap-y-4 flex-wrap bg-base-100 shadow-xl hover:shadow-2xl" key={product.id} to={`/products/${product.id}`}>
                    ...
                    <div className="ml-0 sm:ml-16">
                        <h3 className="capitalize font-mediumtext-lg">{title}</h3>
